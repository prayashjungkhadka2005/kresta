                    ...
                    {filteredProducts.map((product) => (
                        <div key={product.id} className="group flex flex-col bg-white dark:bg-zinc-900/50 rounded-xl border border-gray-100 dark:border-zinc-800 overflow-hidden transition-colors">
                            ...
                            <div className="p-4 flex-1 flex flex-col">
                                ...
                                <p className="text-lg font-black text-gray-900 dark:text-white mb-3 flex items-center gap-2">
                                    NPR {parseFloat(product.price).toLocaleString()}
                                </p>

                                <div className="mt-auto pt-3 border-t border-gray-100 dark:border-zinc-800/50 space-y-3">
